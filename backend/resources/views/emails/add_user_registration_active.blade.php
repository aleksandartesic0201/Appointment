                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="padding-left:5%; padding-right:5%;text-align:left;">
                                                <p class="content">
                                                    You have successfully registered to pulse 24/7 - a platform that
                                                    allow you to book appointments with your favorite service
                                                    providers easily.Please click below to activate your account
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="text-align:center;">
                                                <a style="text-decoration:none" href="{{ 'http://www.pulse247.net/user '.$token }}" class="submit_btn">Active your account</a>
                                            </td>
                                        </tr>
                                        </tr>
                                        <tr>
