                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="padding:6% 10%">
                                                <P class="content">
                                                    We have cancelled the following appointment for you with {{$company->name}}.<br><br>
                                                    ...
                                                    @endif
                                                    <br>
                                                    Reason for Cancelation: {{$appointment->external_reason}}.
                                                    <br><br>

                                                    <br>
                                                    Please don’t hesitate to call us  at {{preg_replace('/(\d{3})(\d{3})(\d{4})/','$1-$2-$3',$company->phone_number)}} if you have any questions.
                                                    <br>
                                                    <br>
                                                    Sincerely,<br>
                                                    {{$company->name}} Team
