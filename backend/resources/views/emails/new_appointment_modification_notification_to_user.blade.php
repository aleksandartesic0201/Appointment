                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td class="user_greet">
                                                <h1 style="padding-left:5%;padding-right:5%;padding-right:5%;">Appointment Modification Notification to User</h1>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;padding-right:5%;">Appointment Confirmation: {{$appoinment->name}} at {{$company->name}} on {{$appoinment->created}}<br/></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="text-align:center;">
                                                <a style="text-decoration:none" href="http://www.pulse247.net/companyname/landing" class="submit_btn">View/Modify Booking</a>
                                            </td>
                                        </tr>
