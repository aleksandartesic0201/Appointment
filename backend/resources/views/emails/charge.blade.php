                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;">Receipt from {{$company->name}}<br/></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="hi" >Hi,&nbsp;&nbsp;{{$customer->name}}</td>
                                        </tr>
                                        <tr>
                                            <td height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;padding-right:5%">
                                                <p class="content">
                                                    We have successfully charged your credit card and here is your receipt -<br>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;"><span style="font-weight:bold">Service Amount:</span>${{$appoinment_transaction->amount}}USD</td>
                                        </tr>
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;"><span style="font-weight:bold">Service Descript:</span>{{$appointment->description}}</td>   
                                        </tr>
                                         <tr>
                                            <td height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;">
                                                <p class="content">
                                                    Sincerely,<br>
                                                   <span class="hi1">{{$company->name}}Team</span><br>
                                                    {{$company->address}}
                                                </p>
                                            </td>
                                        </tr>
