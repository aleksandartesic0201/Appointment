                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;padding-right:5%;">Appointment Confirmation: {{$appointment->name}} at {{$company->name}} on {{$appointment->created}}<br/></td>
                                        </tr>
                                        <tr>
                                            <td height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;padding-right:5%;text-align:left">
                                                <p class="content">
                                                    Please don't hesitate to call us at <span style="font-weight:bold">{{$appointment->phonenumber}}</span>&nbsp;&nbsp;if you have any questions.<br>                                            
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
