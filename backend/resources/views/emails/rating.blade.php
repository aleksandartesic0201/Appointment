                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;padding-right:5%;">Please Rate us For {{$appointment->name}} at {{$company->name}} on {{$appointment->created}}<br/></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;padding-right:5% ">
                                                <p class="content">
                                                    We hope you enjoyed your recent {{$appointment->name} at  {{$company->name}}
                                                    with {{$expert->name}}.We would really appreciate if
                                                    you could take 30 seconds of your busy time and rate your
                                                    experience!
                                        ...
                                        <tr>
                                             <td style="padding-left:5%;text-align:center;"><a style="text-decoration:none" href="http://www.pulse247.net/rating" class="submit_btn">View/Modify Booking</a></td>
                                        </tr>
                                        <tr>
                                            <td height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                        </tr>
