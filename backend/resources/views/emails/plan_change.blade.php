                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td class="user_greet">
                                                <h1 align="center">Dear <span class="username">{{$company->name}}</span>!</h1>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding:6% 10%">
                                                <P class="content">
                                                   Your subscription plan is updated with following details:<br><br>

                                                    Subscription Plan: {{$plan->name}},<br>
                                                    Next Inovice Date: {{date('Y-m-d',$sub['next_payment_attempt'])}}<br>
                                                    Adjusted Amount Due: {{$sub['total']/100}} {{strtoupper($sub['currency'])}}<br>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
