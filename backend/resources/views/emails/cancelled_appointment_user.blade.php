                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td class="user_greet">
                                                <h1 style="padding-left:5%;padding-right:5%;">APPOINTMENT CANCELATION NOTIFICATION TO USER:</h1>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%; text-align:left;padding-right:5%;">Appointment Cancelled: {{$appointment->name}} at {{$company->name}} on {{$appointment->cancel_time}}<br/></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;padding-right:5%;">
                                                <p class="content">
                                                    We have cancelled the following appointment:<br> 
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;"><span style="font-weight:bold">Date and Time:</span>{{$appointment->cancel_time}}</td>   
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;padding-right:5%; text-align:left;"><span style="font-weight:bold">Reason For Cancellation:</span></td>   
                                        </tr>
                                        <tr>
                                            <td style="padding-left:5%; text-align:left;padding-right:5%;">{{$appointment->internal_reason}}</td>
                                        </tr>
                                        <tr>
                                            <td height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                        </tr>
