                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td class="user_greet">
                                                <h1 style="padding-left:5%;padding-right:5%;">APPOINTMENT CANCELATION NOTIFICATION TO Expert: 
                                                </h1>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%; padding-right:5%;text-align:left;">Appointment Canceled for {{$appointment->name}} on {{$appointment->cancel_time}}<br/></td>
                                        </tr>
                                        <tr>
                                            <td height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;padding-right:5%;">
                                                <p class="content">
                                                    The following appointment has been cancelled:<br>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td style="padding-left:5%;padding-right:5%; text-align:left;"><span style="font-weight:bold">Reason For Cancelation:</span></td>   
                                        </tr>
                                        <tr>
                                            <td style="padding-left:5%; text-align:left;padding-right:5%;">{{$appointment->external_reason}}</td>
                                        </tr>
