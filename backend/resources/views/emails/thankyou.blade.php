                                ...
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td class="hi" style="padding-left:5%">Thank you :</td>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;padding-right:5%;">Thank You for {{$appointment->name}} at {{$company->name}} on {{$appointment->created}}<br/></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-left:5%;text-align:left;padding-right:5%;">
                                                <p class="content">
                                                    You recently had the following appointment with {{$company->name}}.
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td style="padding-left:5%;text-align:left;"><span style="font-weight:bold">Service Type:</span>{{$appointment->name}}</td>
                                        </tr>
                                        <tr>
